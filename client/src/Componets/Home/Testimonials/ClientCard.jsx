...
const ClientCard = (prop) => {
  return (
    <div className="clientcard w-2/4 bg-white shadow-md rounded-lg p-6 text-center font-sans">
      <p className="p w-48 text-gray-600 text-base  text-wrap font-medium mb-4">
        "{prop.para}"
      </p>
